...
( function() {
	...
	function attachFileBrowser( editor, dialogName, definition, elements ) {
		...
		for ( var i = elements.length; i--; ) {
			...
			if ( element.filebrowser.action == 'Browse' ) {
				...
				console.log('PL-FB:fc url 1 = ',url)
				if ( url === undefined ) {
				...
				console.log('PL-FB:fc url 2 = ',url)

				if ( url ) {
					var onClick = element.onClick;

					console.log('PL-FB:fc url 3 = ',url)
						...
						if ( uploadFile.call( sender, evt ) ) {
							...
							if ( editor.config.filebrowserUploadMethod === 'form' || !isFileUploadApiSupported ) {
								...
								loader.on( 'uploaded', function( evt ) {
									...
									console.log('PL-FB:on uploaded evt = ',evt)
									console.log('PL-FB:on uploaded evt.sender = ',evt.sender)
									console.log('PL-FB:on uploaded evt.sender.responseData = ',evt.sender.responseData)

									// return setUrl(evt.sender.editor,'https://127.0.0.1:3000/media/ck/test/coffee-1-100x100.jpg', {})
	...
	function setUrl( fileUrl, data ) {
		...
		console.log('PL-FB:setUrl fileUrl = ',fileUrl)
		console.log('PL-FB:setUrl data = ',data)
