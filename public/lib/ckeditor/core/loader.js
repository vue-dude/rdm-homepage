    ...
    CKEDITOR.loader = (function() {
        ...
        var getUrl = function(resource) {
            if (CKEDITOR && CKEDITOR.getUrl) {
                // console.log('LD: resource = ', resource)
                // console.log('LD: CKEDITOR.getUrl(resource) = ', CKEDITOR.getUrl(resource))
                return CKEDITOR.getUrl(resource)
            }
            // console.log('LD: resource = ', resource)
            // console.log('LD: CKEDITOR.basePath = ', CKEDITOR.basePath)
        ...
        return {
                ...
                if (typeof script.onreadystatechange !== 'undefined') {
                    ...
                    script.onload = function() {
                        ...
                        setTimeout(function() {
                            ...
                            const scrLoaded = CKEDITOR.loader.loadedScripts
                            // RDM ADD
            ...
            load: function(scriptName, defer) {
                // console.log('CK:LOADER:load scriptName = ', scriptName)
                ...
                if (document.body && (!document.readyState || document.readyState == 'complete')) {
                    ...
                    // Append this script to the list of loaded scripts.
                    // console.log('CK:LOADER loadedScripts.push scriptName = ', scriptName)
