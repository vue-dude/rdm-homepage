...
( function() {
	...
	function addUploadWidget( editor, name, def ) {
		console.log('obj:addUploadWidget editor, name, def = ',editor, name, def)
		...
		CKEDITOR.tools.extend( def, {
			...
			init: function() {
				...
				loader.on( 'update', function( evt ) {
					console.log('obj:loader.on update evt = ',evt)
					// (#1454)
			...
			_getLoader: function() {
				...
				console.log('obj:_getLoader this.editor.uploadRepository.loaders = ',this.editor.uploadRepository.loaders)
	...
	function bindNotifications( editor, loader ) {
		console.log('obj:bindNotifications editor, loader = ',editor, loader)
		var aggregator,
			task = null;
