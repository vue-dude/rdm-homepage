	...
	CKEDITOR.plugins.add( 'filetools', {
		...
		beforeInit: function( editor ) {
			...
			editor.on( 'fileUploadRequest', function( evt ) {
				...
				console.log('FTOOL:editor.on:fileUploadRequest 1 fileLoader = ',fileLoader)
			...
			editor.on( 'fileUploadRequest', function( evt ) {
				var fileLoader = evt.data.fileLoader,
					...
					console.log('FTOOL:editor.on:fileUploadRequest 2 fileLoader = ',fileLoader)
			...
			// editor.removeEventLisener( 'fileUploadRequest')
